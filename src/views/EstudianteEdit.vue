             ...
             <div class="card-body">
              <form v-on:submit="actualizar">
                <div class="d-grid col-6 mx-auto mb-3">
                  ...
                  <img v-else  height="100" :src="this.foto" class="img-thumbnail" id="fotoimg" alt="">
                </div>
                ...
                <div class="input-group mb-3">
                  ...
                  <input v-on:change = "previsualizarFoto" type="file" accept="image/png, image/jpeg, image/gift" class="form-control">
                </div>
                <div class="d-grid col-6 mx-auto mb-3">
                  <button class="btn btn-warning"><i class="fa-solid fa-refresh"></i> Registrar</button>
                </div>
              </form>
             </div>
         </div>
